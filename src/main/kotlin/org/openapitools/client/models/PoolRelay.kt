 ...
 * 
 *
 * @param ipv4 IPv4 address of the relay
 * @param ipv6 IPv6 address of the relay
 * @param dns DNS name of the relay
 * @param dnsSrv DNS SRV entry of the relay
 * @param port Network port of the relay
 */

data class PoolRelay (
    ...
    @Json(name = "dns")
    var dns: kotlin.String?,

    /* DNS SRV entry of the relay */
    @Json(name = "dns_srv")
    var dnsSrv: kotlin.String?,
