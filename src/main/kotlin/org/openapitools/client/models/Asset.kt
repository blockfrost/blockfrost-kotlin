...
import org.openapitools.client.models.AssetMetadata
...
data class Asset (
    ...
    @Json(name = "initial_mint_tx_hash")
    var initialMintTxHash: kotlin.String,

    /* Count of mint and burn transactions */
    @Json(name = "mint_or_burn_count")
    var mintOrBurnCount: kotlin.Int,
    ...
    @Json(name = "onchain_metadata")
    var onchainMetadata: kotlin.collections.Map<kotlin.String, kotlin.Any>?,
