 ...
 * @param type Type of the script language
 * @param serialisedSize The size of the CBOR serialised script, if a Plutus script
 */

data class Script (

    /* Script hash */
    @Json(name = "script_hash")
    ...
    @Json(name = "serialised_size")
    var serialisedSize: kotlin.Int?
     ...
     * Type of the script language
     *
     * Values: timelock,plutus
     */
    enum class Type(val value: kotlin.String) {
        @Json(name = "timelock") timelock("timelock"),
        @Json(name = "plutus") plutus("plutus");
    }
}
