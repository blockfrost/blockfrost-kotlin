...
class HealthApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    suspend fun healthClockGet() : InlineResponse2002 {
        val localVariableConfig = healthClockGetRequestConfig()

        val localVarResponse = request<Unit, InlineResponse2002>(
            localVariableConfig
        )
    ...
    /**
    * To obtain the request config of the operation healthClockGet
    *
    * @return RequestConfig
    */
    fun healthClockGetRequestConfig() : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun rootGet() : InlineResponse200 {
