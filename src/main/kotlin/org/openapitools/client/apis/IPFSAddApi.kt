...
class IPFSAddApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun ipfsAddPost() : InlineResponse2003 {
        val localVariableConfig = ipfsAddPostRequestConfig()

        val localVarResponse = request<Unit, InlineResponse2003>(
            localVariableConfig
        )
    ...
    /**
    * To obtain the request config of the operation ipfsAddPost
    *
    * @return RequestConfig
    */
    fun ipfsAddPostRequestConfig() : RequestConfig<Unit> {
