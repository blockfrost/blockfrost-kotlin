...
class IPFSGatewayApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun ipfsGatewayIPFSPathGet(ipFSPath: kotlin.String) : Unit {
        val localVariableConfig = ipfsGatewayIPFSPathGetRequestConfig(ipFSPath = ipFSPath)
    ...
    /**
    * To obtain the request config of the operation ipfsGatewayIPFSPathGet
    *
    * @param ipFSPath  
    * @return RequestConfig
    */
    fun ipfsGatewayIPFSPathGetRequestConfig(ipFSPath: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/ipfs/gateway/{IPFS_path}".replace("{"+"IPFS_path"+"}", "$ipFSPath"),
