...
class CardanoNetworkApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun networkGet() : Network {
        val localVariableConfig = networkGetRequestConfig()

        val localVarResponse = request<Unit, Network>(
            localVariableConfig
        )
    ...
    /**
    * To obtain the request config of the operation networkGet
    *
    * @return RequestConfig
    */
    fun networkGetRequestConfig() : RequestConfig<Unit> {
