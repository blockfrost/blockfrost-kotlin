...
class MetricsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun metricsEndpointsGet() : kotlin.collections.List<kotlin.Any> {
        val localVariableConfig = metricsEndpointsGetRequestConfig()
    ...
    /**
    * To obtain the request config of the operation metricsEndpointsGet
    *
    * @return RequestConfig
    */
    fun metricsEndpointsGetRequestConfig() : RequestConfig<Unit> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun metricsGet() : kotlin.collections.List<kotlin.Any> {
        val localVariableConfig = metricsGetRequestConfig()
    ...
    /**
    * To obtain the request config of the operation metricsGet
    *
    * @return RequestConfig
    */
    fun metricsGetRequestConfig() : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
