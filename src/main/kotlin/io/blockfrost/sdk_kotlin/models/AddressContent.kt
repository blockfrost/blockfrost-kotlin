 ...
 * 
 *
 * @param address Bech32 encoded addresses
 * @param amount 
 * @param stakeAddress Stake address that controls the key
 * @param type Address era
 * @param script True if this is a script address
 */
...
data class AddressContent (
    ...
    /* Address era */
    @Json(name = "type")
    var type: AddressContent.Type,

    /* True if this is a script address */
    @Json(name = "script")
    var script: kotlin.Boolean
