...
import io.blockfrost.sdk.kotlin.retrofit.IPFSGatewayApi as IPFSGatewayApiRetrofit

open class IPFSGatewayApi(config: BlockfrostConfig = BlockfrostConfig.defaultConfig) : ApiClient(config) {
    val api by lazy {
        createService(IPFSGatewayApiRetrofit::class.java)
    }
