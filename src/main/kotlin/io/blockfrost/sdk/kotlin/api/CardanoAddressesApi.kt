...
import io.blockfrost.sdk.kotlin.retrofit.CardanoAddressesApi as CardanoAddressesApiRetrofit

open class CardanoAddressesApi(config: BlockfrostConfig = BlockfrostConfig.defaultConfig) : ApiClient(config) {
    val api by lazy {
        createService(CardanoAddressesApiRetrofit::class.java)
    }
     ...
     */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    open suspend fun getAddressTransactions(
        address: kotlin.String,
    ...
    /**
     * Address transactions. Fetches all paged records, returns a Flow.
     * Transactions on the address.
     ...
     * @return Flow<kotlin.collections.List<AddressTransactionsContent>>
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
     * @throws ServerException If the API returns a server error response
     */
    ...
    /**
     * Address transactions. Fetches all paged records, returns as a list.
     * Transactions on the address.
     * parameter address: (path) Bech32 address.
     * parameter order: (query) The ordering of items from the point of view of the blockchain, not the page listing itself. By default, we return oldest first, newest last.  (optional, default to null)
     * parameter from: (query) The block number and optionally also index from which (inclusive) to start search for results, concatenated using colon. Has to be lower than or equal to &#x60;to&#x60; parameter.  (optional)
    ...
    open suspend fun getAddressTransactionsAllList(
        address: kotlin.String, order: SortOrder? = null, from: kotlin.String? = null, to: kotlin.String? = null,
        batchSize: Int? = null,
    ): List<AddressTransactionsContent> {
        return getAddressTransactionsAll(
            address = address,
            order = order,
            from = from,
            to = to,
     ...
     * Transactions on the address.
     * @param address Bech32 address.
     * @param count The number of transactions per page. (optional, default to null)
     * @param page The page number for listing the results. (optional, default to null)
     * @param order The ordering of items from the point of view of the blockchain, not the page listing itself. By default, we return oldest first, newest last.  (optional, default to null)
    ...
    open suspend fun getAddressTxs(
    ...
    /**
     * Address UTXOs. Fetches all paged records, returns a Flow.
     * UTXOs of the address.
     * parameter address: (path) Bech32 address.
     ...
     * parameter batchSize: Number of concurrent requests for page download. If null, config.batchSize is used.
     * @return Flow<kotlin.collections.List<AddressUtxoContent>>
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
     * @throws ServerException If the API returns a server error response
     */
    ...
    /**
     * Address UTXOs. Fetches all paged records, returns as a list.
     * UTXOs of the address.
     * parameter address: (path) Bech32 address.
     * parameter order: (query) Ordered by tx index in the block. The ordering of items from the point of view of the blockchain, not the page listing itself. By default, we return oldest first, newest last.  (optional, default to null)
     * parameter batchSize: Number of concurrent requests for page download. If null, config.batchSize is used.
