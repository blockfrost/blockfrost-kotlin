 ...
 * 
 *
 * @param index Index of the certificate within the transaction
 * @param certIndex Index of the certificate within the transaction
 * @param address Bech32 delegation stake address
 * @param poolId Bech32 ID of delegated stake pool
 * @param activeEpoch Epoch in which the delegation becomes active
 */

data class TxContentDelegation (
