 ...
 * @param amount 
 * @param txHash Hash of the UTXO transaction
 * @param outputIndex UTXO index in the transaction
 * @param dataHash The hash of the transaction output datum
 * @param collateral Whether the input is a collateral consumed on script validation failure
 */

data class TxContentUtxoInputs (
    ...
    @Json(name = "amount")
    var amount: kotlin.collections.List<TxContentOutputAmount>,
    ...
    var outputIndex: java.math.BigDecimal,
