 ...
 * 
 *
 * @param max Maximum supply in Lovelaces
 * @param total Current total (max supply - reserves) supply in Lovelaces
 * @param circulating Current circulating (UTXOs + withdrawables) supply in Lovelaces
 * @param locked Curent locked supply by scripts in Lovelaces
 */

data class NetworkSupply (
