 ...
 * 
 *
 * @param txHash Transaction hash that contains the specific metadata
 * @param cborMetadata Content of the CBOR metadata
 */

data class TxMetadataLabelCbor (
    ...
    @Json(name = "cbor_metadata")
    var cborMetadata: kotlin.String?
