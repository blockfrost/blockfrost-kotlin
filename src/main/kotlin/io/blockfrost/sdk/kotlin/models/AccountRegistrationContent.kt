 ...
 * 
 *
 * @param txHash Hash of the transaction containing the (de)registration certificate
 * @param action Action in the certificate
 */
...
data class AccountRegistrationContent (
    ...
    @Json(name = "action")
    var action: AccountRegistrationContent.Action
