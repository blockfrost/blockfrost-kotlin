 ...
 * @param metadataUrl URL of the specific metadata file
 * @param metadataHash Hash of the metadata file
 * @param metadata The cached metadata of the `metadata_url` file.
 */
...
data class NutlinkAddress (
    ...
    var metadataUrl: kotlin.String,

    /* Hash of the metadata file */
    @Json(name = "metadata_hash")
    var metadataHash: kotlin.String,

    /* The cached metadata of the `metadata_url` file. */
    @Json(name = "metadata")
    var metadata: kotlin.collections.Map<kotlin.String, kotlin.Any>?
