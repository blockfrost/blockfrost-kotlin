 ...
 * 
 *
 * @param txHash Hash of the transaction containing the asset action
 * @param action Action executed upon the asset policy
 * @param amount Asset amount of the specific action
 */
...
data class AssetHistory (
    ...
    @Json(name = "action")
    var action: AssetHistory.Action,
    ...
    enum class Action(val value: kotlin.String) {
        ...
        @Json(name = "burned") burned("burned");
    }
}
