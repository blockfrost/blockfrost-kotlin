 ...
 * @param txIndex UTXO index in the transaction
 * @param outputIndex UTXO index in the transaction
 * @param amount 
 * @param block Block hash of the UTXO
 * @param dataHash The hash of the transaction output datum
 */

data class AddressUtxoContent (
    ...
    var outputIndex: kotlin.Int,

    @Json(name = "amount")
    var amount: kotlin.collections.List<kotlin.Any>,
