 ...
 * @param receivedSum 
 * @param sentSum 
 * @param txCount Count of all transactions on the address
 */

data class AddressContentTotal (

    /* Bech32 encoded address */
    @Json(name = "address")
    var address: kotlin.String,

    @Json(name = "received_sum")
    var receivedSum: kotlin.collections.List<TxContentOutputAmount>,

    @Json(name = "sent_sum")
    var sentSum: kotlin.collections.List<TxContentOutputAmount>,
